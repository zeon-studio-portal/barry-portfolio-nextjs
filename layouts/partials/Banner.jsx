...
const Banner = ({ banner }) => {
  ...
  useOnClickOutside(videoPopupRef, () => {
  ...
  return (
    <>
      ...
      {isVideoPopupOpen && (
        <PortalModal>
          <PortalModal.Close handleClose={() => setVideoPopupOpen(false)} />
          <div className="w-[800px] mx-auto" ref={videoPopupRef}>
            <ReactPlayerWrapperV2 url={banner.video_button.mediaLink_supports_youtube_vimeo} autoplay={true} />
          </div>
        </PortalModal>
      )}
    </>
