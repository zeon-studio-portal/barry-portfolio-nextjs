    ...
    <section className="section bg-primary-600 py-24">
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row  gap-8">
          {/* LEFT SIDE */}
          <div className="lg:w-[50%] max-h-[480px]">
            {activeVideo && (
              <div>
                <iframe
                ...
                ></iframe>
                <div>
                  <h3 className="text-base  font-medium text-light-primary mb-4">{activeVideo.head}</h3>
                  <p className="text-black font-medium text-h6 md:text-h5 leading-tight">{activeVideo.title}</p>
                </div>
              </div>
            )}
          </div>
          {/* RIGHT SIDE */}
          <div className="lg:w-[50%] max-h-[480px] overflow-y-scroll">
                    ...
                    (item) =>
                      item.enable && (
                        ...
                        >
                          ...
                          {/* CONTENT */}
                          <div className=" w-[70%]">
                            <h3 className="text-base  font-medium text-light-primary mb-4">{item.head}</h3>
                            <p className="text-black font-medium text-h6 md:text-h5 leading-tight">{item.title}</p>
                          </div>
                        </div>
                      )
                  )}
