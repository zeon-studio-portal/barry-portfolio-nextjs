...
subtitle: >-
  Barry is a trusted experienced guide for transformative experiences.
list:
  - enable: true
    title: Experience Guide For Work & Life Transformation
    description: Barry co-founded 1heart where 95% of 1,000+ alumni received
  ...
  - enable: true
    ...
    description: I am the co-founder of Miami made. with a mission to create a more
